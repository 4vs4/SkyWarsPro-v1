 ...
 */
class CustomProvider implements EconomyProvider {
    ...
    public function getMoney(Player $player) {
        return DataStorage::getPlayerInformation($player)->getCoins();
    }
    ...
    public function setMoney(Player $player, $money) {
        DataStorage::getPlayerInformation($player)->setCoins($money);
    }
}