...
class MySQLDataProvider extends DataProvider {
    ...
    public function init() {
        ...
        $this->dataBase->query("CREATE DATABASE IF NOT EXISTS SkyWars");
        ...
        $this->dataBase->select_db("SkyWars");
        $this->dataBase->query("CREATE TABLE IF NOT EXISTS arenas (id VARCHAR(99) PRIMARY KEY, args TEXT)");

        // Kits data

        $this->dataBase->query("CREATE TABLE IF NOT EXISTS kits (player VARCHAR(99) PRIMARY KEY, kits TEXT)");
    }
