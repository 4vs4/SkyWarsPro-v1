...
class YamlDataProvider extends DataProvider {
    ...
    public function getKits(): array {
        if(!is_file($this->getDataFolder() . "data" . DIRECTORY_SEPARATOR . "kits.yml")) {
            return [];
        }
        return (array) yaml_parse_file($this->getDataFolder() . "data" . DIRECTORY_SEPARATOR . "kits.yml");
    }
    ...
    public function saveKits(array $kits) {
        ...
        file_put_contents($this->getDataFolder() . "data" . DIRECTORY_SEPARATOR . "kits.yml", yaml_emit($kits));
    }
